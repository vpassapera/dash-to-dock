...
EXTRA_MODULES = dockedDash.js intellihide.js myDash.js widgets.js convenience.js prefs.js
EXTRA_MEDIA = one.svg two.svg three.svg four.svg one_rtl.svg two_rtl.svg four_btt.png one_btt.png three_btt.png two_btt.png four_ttb.png one_ttb.png  three_ttb.png two_ttb.png three_rtl.svg four_rtl.svg
TOLOCALIZE =  prefs.js
